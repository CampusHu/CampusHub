...
//
//     // courseGrade를 먼저 정의합니다.
//     const courseGradeSelect = document.getElementById('prof_course_registration_grade');
//     const courseGradeValue = parseInt(courseGradeSelect.value, 10);
//
//     // courseGrade 문자열 매핑
//     const courseGradeMapping = {
//         1: "1학년",
//         2: "2학년",
//         3: "3학년",
//         4: "4학년"
//     };
//
//     // courseGrade를 매핑하여 문자열로 설정
//     const courseGrade = courseGradeMapping[courseGradeValue] || "4학년"; // 기본값 설정
//
//     // 데이터 객체 생성
//     const courseData = {
//         courseName: courseName,
//         room: room,
//         division: division, // 매핑하지 않고 그대로 사용
//         courseDay: courseDay,
//         courseGrade: courseGrade, // 문자열로 전달
...
document.getElementById('prof_course_registration_newBtn').addEventListener('click', function () {
    ...
    document.getElementById('prof_course_registration_credits').value = '';
    document.getElementById('prof_course_registration_classroom').value = '';
    document.getElementById('courseType').value = '전공필수';
    document.getElementById('dayOfWeek').value = '월';
    document.getElementById('classTime').value = '1';
    document.getElementById('endClassTime').value = '1';
...
document.getElementById('prof_course_registration_savBtn').addEventListener('click', function () {
    const courseName = document.getElementById('prof_course_registration_name').value;
    const courseGrade = parseInt(document.getElementById('prof_course_registration_grade').value, 10);
    const credits = parseInt(document.getElementById('prof_course_registration_credits').value, 10);
    const room = document.getElementById('prof_course_registration_classroom').value;
    const division = document.getElementById('courseType').value;
    const courseDay = document.getElementById('dayOfWeek').value;
